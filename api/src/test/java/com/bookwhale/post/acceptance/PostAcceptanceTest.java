...
public class PostAcceptanceTest extends AcceptanceTest {
    ...
    void createPost() {
        ...
        ExtractableResponse<Response> res = PostAcceptanceStep.requestToCreatePost(jwt,
            postRequest);
    ...
    void findPosts_anonymousUser() {
        ...
        ExtractableResponse<Response> response = PostAcceptanceStep.requestToFindPosts(
            "anonymousUser",
            postsRequest, pagination);
        List<PostsResponse> postsResponses = response.jsonPath()
            .getList(".", PostsResponse.class);
    ...
    void deletePost() {
        ...
        ExtractableResponse<Response> response = PostAcceptanceStep.requestToDeletePost(jwt,
            postId);
