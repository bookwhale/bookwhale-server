package com.teamherb.bookstoreback.chatroom.acceptance.step;

import static com.teamherb.bookstoreback.post.acceptance.step.PostAcceptanceStep.requestToCreatePost;
import static com.teamherb.bookstoreback.post.acceptance.step.PostAcceptanceStep.requestToFindPost;
...
public class ChatRoomAcceptanceStep {
  ...
  public static ExtractableResponse<Response> createChatRoom(String loginUserJwt, String sellerJwt,
      PostRequest postRequest) {
    Long postId = AcceptanceUtils.getIdFromResponse(requestToCreatePost(sellerJwt, postRequest));
